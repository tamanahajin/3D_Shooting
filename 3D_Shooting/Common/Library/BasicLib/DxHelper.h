...
// 日本語： ComPtr<T> のデバッグ用の名前をつけるためのヘルパーマクロ
// 変数の名前をオブジェクトの名前として割り当てます。
// 例：NAME_D3D12_OBJECT(m_vertexBuffer);　→　SetName(m_vertexBuffer.Get(), L"m_vertexBuffer");
// PIX / RenderDoc / VS Graphics Diagnostics などのツールでオブジェクト名が表示されるようになり、デバッグが楽になる
